...
INSERT INTO category (name, description, content, iconUrl) VALUES
('웹 해킹', 'SQL Injection, XSS, CSRF 등 웹 애플리케이션 보안 취약점 분석 및 대응',
...
('시스템 해킹', 'Buffer Overflow, ROP 등 시스템 레벨 취약점 분석 및 익스플로잇 개발',
...
('디지털 포렌식', '디지털 증거 수집 및 분석, 사고 대응을 위한 포렌식 기법',
...
('네트워크 보안', '네트워크 트래픽 분석, 침입 탐지 및 방화벽 보안 기술',
...
('IoT 보안', '스마트 기기의 보안 취약점을 분석 및 대응',
